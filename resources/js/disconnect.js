...
window.addEventListener("load", async () => {
    ...
    document.getElementById("wallet-address").textContent = `${fullAddr.slice(0, 6)}...${fullAddr.slice(-6)}`; 
    document.getElementById("wallet-address-detail").textContent = `${fullAddr.slice(0, 6)}...${fullAddr.slice(-6)}`; 
