                ...
                <div class="d-flex flex-column gap-3">
                    <div class="d-flex align-items-center justify-content-between gap-2 flex-wrap">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <code id="wallet-address-board" class="mb-0">0xacc3...965d</code>
                            <button type="button" class="btn btn-sm btn-light" id="copy-wallet-address">
                                <i class="fi fi-rr-copy me-1"></i>Copy
                            </button>
                            <button type="button" class="btn btn-sm btn-outline-primary" id="btn-generate-api-key">
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-2 flex-wrap" id="api-key-row" style="display:none!important">
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-2 flex-wrap" id="secret-key-row" style="display:none!important">
