...
function deserializeAccountAuthenticatorInput(deserializer) {
  const address = deserializer.deserialize(import_ts_sdk.AccountAddress);
  const authenticator = deserializer.deserialize(import_ts_sdk.AccountAuthenticator);
...
function serializePublicKey(serializer, value) {
  if (value instanceof import_ts_sdk2.Ed25519PublicKey) {
    serializer.serializeU32AsUleb128(import_ts_sdk2.SigningScheme.Ed25519);
  } else if (value instanceof import_ts_sdk2.MultiEd25519PublicKey) {
    serializer.serializeU32AsUleb128(import_ts_sdk2.SigningScheme.MultiEd25519);
  } else if (value instanceof import_ts_sdk2.AnyPublicKey) {
    serializer.serializeU32AsUleb128(import_ts_sdk2.SigningScheme.SingleKey);
  } else if (value instanceof import_ts_sdk2.MultiKey) {
    serializer.serializeU32AsUleb128(import_ts_sdk2.SigningScheme.MultiKey);
  } else {
...
function deserializePublicKey(deserializer) {
  ...
  switch (signingScheme) {
    case import_ts_sdk2.SigningScheme.Ed25519:
      return deserializer.deserialize(import_ts_sdk2.Ed25519PublicKey);
    case import_ts_sdk2.SigningScheme.MultiEd25519:
      return deserializer.deserialize(import_ts_sdk2.MultiEd25519PublicKey);
    case import_ts_sdk2.SigningScheme.SingleKey:
      return deserializer.deserialize(import_ts_sdk2.AnyPublicKey);
    case import_ts_sdk2.SigningScheme.MultiKey:
      return deserializer.deserialize(import_ts_sdk2.MultiKey);
    default:
...
function deserializeAccountInfo(deserializer) {
  const address = deserializer.deserialize(import_ts_sdk3.AccountAddress);
...
function deserializeEntryFunctionArgument(deserializer) {
  ...
  switch (variant) {
    ...
    case 4 /* AccountAddress */: {
      return deserializer.deserialize(import_ts_sdk5.AccountAddress);
    }
    case 2 /* String */: {
    ...
    case 5 /* FixedBytes */: {
      ...
      return new import_ts_sdk5.FixedBytes(bytes);
    }
    default: {
...
function serializeSignature(serializer, value) {
  if (value instanceof import_ts_sdk6.Ed25519Signature) {
    serializer.serializeU32AsUleb128(import_ts_sdk6.SigningScheme.Ed25519);
  } else if (value instanceof import_ts_sdk6.MultiEd25519Signature) {
    serializer.serializeU32AsUleb128(import_ts_sdk6.SigningScheme.MultiEd25519);
  } else if (value instanceof import_ts_sdk6.AnySignature) {
    serializer.serializeU32AsUleb128(import_ts_sdk6.SigningScheme.SingleKey);
  } else {
...
function deserializeSignature(deserializer) {
  const signingScheme = deserializer.deserializeUleb128AsU32();
  switch (signingScheme) {
    case import_ts_sdk6.SigningScheme.Ed25519:
      return deserializer.deserialize(import_ts_sdk6.Ed25519Signature);
    case import_ts_sdk6.SigningScheme.MultiEd25519:
      return deserializer.deserialize(import_ts_sdk6.MultiEd25519Signature);
    case import_ts_sdk6.SigningScheme.SingleKey:
      return deserializer.deserialize(import_ts_sdk6.AnySignature);
    default:
      throw new Error(`Unknown signing scheme: ${signingScheme}`);
  }
}
...
function serializeTypeArguments(serializer, typeArguments) {
  ...
  for (const typeArgument of typeArguments) {
    const typeTag = typeof typeArgument === "string" ? (0, import_ts_sdk7.parseTypeTag)(typeArgument, { allowGenerics: true }) : typeArgument;
...
function deserializeTypeArguments(deserializer) {
  ...
  for (let i = 0; i < typeArgumentsLength; i += 1) {
    const typeTag = deserializer.deserialize(import_ts_sdk7.TypeTag);
...
function serializeTransactionPayloadInput(serializer, value) {
  if ("multisigAddress" in value) {
    ...
    const multisigAddress = import_ts_sdk7.AccountAddress.from(value.multisigAddress);
    ...
    const bytecode = import_ts_sdk7.Hex.fromHexInput(value.bytecode);
...
function deserializeTransactionPayloadInput(deserializer) {
  ...
  switch (variant) {
    case 2 /* Multisig */: {
      ...
      const multisigAddress = deserializer.deserialize(import_ts_sdk7.AccountAddress);
      return {
        function: functionId,
        functionArguments,
        multisigAddress,
    ...
    case 1 /* Script */: {
      ...
      const functionArguments = [];
      for (let i = 0; i < functionArgumentsLength; i += 1) {
        const argument = (0, import_ts_sdk7.deserializeFromScriptArgument)(deserializer);
...
function chainIdToNetwork(chainId) {
  if (chainId === import_ts_sdk8.NetworkToChainId.mainnet) {
    return import_ts_sdk8.Network.MAINNET;
  }
  if (chainId === import_ts_sdk8.NetworkToChainId.testnet) {
    return import_ts_sdk8.Network.TESTNET;
  }
  if (chainId >= 50 && chainId < 100 || chainId >= 100 && chainId < 125) {
    return shelbynet.name;
  }
  return import_ts_sdk8.Network.DEVNET;
}
function isSupportedNetwork(network) {
  return [
    import_ts_sdk8.Network.MAINNET,
    import_ts_sdk8.Network.TESTNET,
    import_ts_sdk8.Network.DEVNET,
    shelbynet.name
  ].includes(network);
}
...
((ConnectRequest2) => {
  ...
  function deserializeArgs(deserializer, version) {
    ...
    let claimOptions;
    if (hasClaimOptions) {
      const secretKey = deserializer.deserialize(import_ts_sdk10.Ed25519PrivateKey);
...
function deserializeWalletResponse({ data }, deserializeFn) {
  const deserializer = new import_ts_sdk11.Deserializer(data);
...
((SignAndSubmitTransactionRequest2) => {
  ...
  function deserializeArgs(deserializer, version) {
    ...
    const payload = isPayloadBcsSerializable ? deserializer.deserialize(import_ts_sdk12.TransactionPayload) : deserializeTransactionPayloadInput(deserializer);
...
function deserializeAptosSignInOutputV1(deserializer) {
  return {
    account: new import_wallet_standard.AccountInfo(deserializeAccountInfo(deserializer)),
...
((SignTransactionRequest2) => {
  ...
  function deserializeArgs(deserializer, version) {
    const hasSignerAddress = version >= 3 && deserializer.deserializeBool();
    const signerAddress = hasSignerAddress ? deserializer.deserialize(import_ts_sdk14.AccountAddress) : void 0;
    const network = version === 1 ? deserializer.deserializeStr() : deserializer.deserializeOption("string");
    if (network !== void 0 && !isSupportedNetwork(network)) {
      throw new Error(`Unsupported network '${network}'`);
    }
    ...
    const payload = isPayloadBcsSerializable ? deserializer.deserialize(import_ts_sdk14.TransactionPayload) : deserializeTransactionPayloadInput(deserializer);
...
((SignTransactionResponse2) => {
  ...
  function deserializeApprovalArgs(deserializer) {
    const authenticator = deserializer.deserialize(import_ts_sdk15.AccountAuthenticator);
    const hasRawTransaction = deserializer.deserializeBool();
    const rawTransaction = hasRawTransaction ? deserializer.deserialize(import_ts_sdk15.RawTransaction) : void 0;
    return {
      authenticator,
      rawTransaction
    };
...
function urlDecodeWalletRequest(encodedRequest) {
  const deserializer = new import_ts_sdk16.Deserializer(base64ToBytes(encodedRequest));
  const name = deserializer.deserializeStr();
...
function decodePopupWalletRequest(encoded) {
  ...
  return JSON.parse(serialized, (key, value) => {
    switch (key) {
      ...
      case "clientIdentityKey":
        return new import_ts_sdk17.Ed25519PublicKey(base64ToBytes(value));
      case "signature":
        return new import_ts_sdk17.Ed25519Signature(base64ToBytes(value));
      default:
        return value;
    }
  });
...
function makePopupWalletRequestChallenge({
  ...
  if (accountAddress !== void 0) {
    serializer.serialize(import_ts_sdk17.AccountAddress.from(accountAddress));
  }
