...
import {
  ...
  SigningScheme as SigningScheme2
} from "@aptos-labs/ts-sdk";
...
function serializeTypeArguments(serializer, typeArguments) {
  ...
  for (const typeArgument of typeArguments) {
    const typeTag = typeof typeArgument === "string" ? parseTypeTag(typeArgument, { allowGenerics: true }) : typeArgument;
...
import {
  ...
  Ed25519PublicKey as Ed25519PublicKey2,
  Ed25519Signature as Ed25519Signature2,
  Serializer as Serializer17
} from "@aptos-labs/ts-sdk";
